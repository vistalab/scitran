...
%    struct - Convert the object to a struct
    classdef Subject < flywheel.ModelBase & flywheel.mixins.SubjectMixin
    % NOTE: This file is auto generated by the swagger code generator program.
    % Do not edit the file manually.
    properties (Constant)
        propertyMap = containers.Map({ 'id', 'project', 'firstname', 'lastname', 'age', 'sex', 'cohort', 'mlset', 'type', 'race', 'ethnicity', 'species', 'strain', 'label', 'code', 'masterCode', 'tags', 'info', 'files', 'parents', 'created', 'modified', 'revision', 'permissions', 'notes', 'infoExists', 'analyses' }, ...
            { '_id', 'project', 'firstname', 'lastname', 'age', 'sex', 'cohort', 'mlset', 'type', 'race', 'ethnicity', 'species', 'strain', 'label', 'code', 'master_code', 'tags', 'info', 'files', 'parents', 'created', 'modified', 'revision', 'permissions', 'notes', 'info_exists', 'analyses' });
    end
    ...
    methods
        function obj = Subject(varargin)
            obj@flywheel.ModelBase(flywheel.model.Subject.propertyMap);
        ...
        function result = toJson(obj)
            ...
            if isKey(obj.props_, 'mlset')
                result('mlset') = flywheel.ModelBase.serializeValue(obj.props_('mlset'), 'char');
            end
            if isKey(obj.props_, 'type')
    ...
    methods(Static)
        function obj = fromJson(json, context)
            ...
            if isfield(json, 'mlset')
                obj.props_('mlset') = flywheel.ModelBase.deserializeValue(json.mlset, 'char');
            end
        ...
        function obj = ensureIsInstance(obj)
            if ~isempty(obj)
                ...
                if ~isa(obj, 'flywheel.model.Subject')
                    obj = flywheel.model.Subject(obj);
                end
                if isKey(obj.props_, '_id')
                end
                if isKey(obj.props_, 'project')
