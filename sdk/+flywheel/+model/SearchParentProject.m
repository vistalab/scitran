% SearchParentProject
%
% SearchParentProject Properties:
...
%    analyses    
%
% SearchParentProject Methods:
%    toJson - Convert the object to a Map that can be encoded to json
%    struct - Convert the object to a struct
    classdef SearchParentProject < flywheel.ModelBase & flywheel.mixins.ProjectMixin
    ...
    methods
        function obj = SearchParentProject(varargin)
            obj@flywheel.ModelBase(flywheel.model.SearchParentProject.propertyMap);
    ...
    methods(Static)
        function obj = fromJson(json, context)
            obj =  flywheel.model.SearchParentProject;
        ...
        function obj = ensureIsInstance(obj)
            if ~isempty(obj)
                ...
                if ~isa(obj, 'flywheel.model.SearchParentProject')
                    obj = flywheel.model.SearchParentProject(obj);
                end
                if isKey(obj.props_, 'label')
                end
                if isKey(obj.props_, 'info')
