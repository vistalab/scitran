...
%
% RolesBackwardsCompatibleRoleAssignment Properties:
%    id       - Database ID of a user
%    roleIds 
%    access  
%
% RolesBackwardsCompatibleRoleAssignment Methods:
%    toJson - Convert the object to a Map that can be encoded to json
%    struct - Convert the object to a struct
    classdef RolesBackwardsCompatibleRoleAssignment < flywheel.ModelBase
    ...
    methods
        function obj = RolesBackwardsCompatibleRoleAssignment(varargin)
            obj@flywheel.ModelBase(flywheel.model.RolesBackwardsCompatibleRoleAssignment.propertyMap);
    ...
    methods(Static)
        function obj = fromJson(json, context)
            obj =  flywheel.model.RolesBackwardsCompatibleRoleAssignment;
        ...
        function obj = ensureIsInstance(obj)
            if ~isempty(obj)
                ...
                if ~isa(obj, 'flywheel.model.RolesBackwardsCompatibleRoleAssignment')
                    obj = flywheel.model.RolesBackwardsCompatibleRoleAssignment(obj);
                end
                if isKey(obj.props_, '_id')
                end
                if isKey(obj.props_, 'role_ids')
