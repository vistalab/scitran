% InlineResponse2005
%
% InlineResponse2005 Properties:
%    modified    
%    jobsSpawned 
%
% InlineResponse2005 Methods:
%    toJson - Convert the object to a Map that can be encoded to json
%    struct - Convert the object to a struct
    classdef InlineResponse2005 < flywheel.ModelBase
    ...
    methods
        function obj = InlineResponse2005(varargin)
            obj@flywheel.ModelBase(flywheel.model.InlineResponse2005.propertyMap);
    ...
    methods(Static)
        function obj = fromJson(json, context)
            obj =  flywheel.model.InlineResponse2005;
        ...
        function obj = ensureIsInstance(obj)
            if ~isempty(obj)
                ...
                if ~isa(obj, 'flywheel.model.InlineResponse2005')
                    obj = flywheel.model.InlineResponse2005(obj);
                end
                if isKey(obj.props_, 'modified')
                end
                if isKey(obj.props_, 'jobs_spawned')
