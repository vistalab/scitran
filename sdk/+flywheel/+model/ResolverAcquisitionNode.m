...
%
% ResolverAcquisitionNode Properties:
...
%    analyses    
%
% ResolverAcquisitionNode Methods:
%    toJson - Convert the object to a Map that can be encoded to json
%    struct - Convert the object to a struct
    classdef ResolverAcquisitionNode < flywheel.ModelBase & flywheel.mixins.AcquisitionMixin
    ...
    methods
        function obj = ResolverAcquisitionNode(varargin)
            obj@flywheel.ModelBase(flywheel.model.ResolverAcquisitionNode.propertyMap);
    ...
    methods(Static)
        function obj = fromJson(json, context)
            obj =  flywheel.model.ResolverAcquisitionNode;
        ...
        function obj = ensureIsInstance(obj)
            if ~isempty(obj)
                ...
                if ~isa(obj, 'flywheel.model.ResolverAcquisitionNode')
                    obj = flywheel.model.ResolverAcquisitionNode(obj);
                end
                if isKey(obj.props_, 'label')
                end
                if isKey(obj.props_, 'info')
