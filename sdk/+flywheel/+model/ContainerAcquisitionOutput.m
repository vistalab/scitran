...
%
% ContainerAcquisitionOutput Properties:
...
%    analyses    
%
% ContainerAcquisitionOutput Methods:
%    toJson - Convert the object to a Map that can be encoded to json
%    struct - Convert the object to a struct
    classdef ContainerAcquisitionOutput < flywheel.ModelBase & flywheel.mixins.AcquisitionMixin
    ...
    methods
        function obj = ContainerAcquisitionOutput(varargin)
            obj@flywheel.ModelBase(flywheel.model.ContainerAcquisitionOutput.propertyMap);
    ...
    methods(Static)
        function obj = fromJson(json, context)
            obj =  flywheel.model.ContainerAcquisitionOutput;
        ...
        function obj = ensureIsInstance(obj)
            if ~isempty(obj)
                ...
                if ~isa(obj, 'flywheel.model.ContainerAcquisitionOutput')
                    obj = flywheel.model.ContainerAcquisitionOutput(obj);
                end
                if isKey(obj.props_, 'label')
                end
                if isKey(obj.props_, 'info')
