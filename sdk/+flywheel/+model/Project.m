...
%    struct - Convert the object to a struct
    classdef Project < flywheel.ModelBase & flywheel.mixins.ProjectMixin
    ...
    methods
        function obj = Project(varargin)
            obj@flywheel.ModelBase(flywheel.model.Project.propertyMap);
    ...
    methods(Static)
        ...
        function obj = ensureIsInstance(obj)
            if ~isempty(obj)
                ...
                if ~isa(obj, 'flywheel.model.Project')
                    obj = flywheel.model.Project(obj);
                end
                if isKey(obj.props_, 'label')
                end
                if isKey(obj.props_, 'info')
