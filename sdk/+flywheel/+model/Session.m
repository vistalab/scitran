...
%    struct - Convert the object to a struct
    classdef Session < flywheel.ModelBase & flywheel.mixins.SessionMixin
    ...
    methods
        function obj = Session(varargin)
            obj@flywheel.ModelBase(flywheel.model.Session.propertyMap);
    ...
    methods(Static)
        ...
        function obj = ensureIsInstance(obj)
            if ~isempty(obj)
                ...
                if ~isa(obj, 'flywheel.model.Session')
                    obj = flywheel.model.Session(obj);
                end
                if isKey(obj.props_, 'operator')
                end
                if isKey(obj.props_, 'label')
