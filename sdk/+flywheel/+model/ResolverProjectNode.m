% ResolverProjectNode
%
% ResolverProjectNode Properties:
...
%    analyses    
%
% ResolverProjectNode Methods:
%    toJson - Convert the object to a Map that can be encoded to json
%    struct - Convert the object to a struct
    classdef ResolverProjectNode < flywheel.ModelBase & flywheel.mixins.ProjectMixin
    ...
    methods
        function obj = ResolverProjectNode(varargin)
            obj@flywheel.ModelBase(flywheel.model.ResolverProjectNode.propertyMap);
    ...
    methods(Static)
        function obj = fromJson(json, context)
            obj =  flywheel.model.ResolverProjectNode;
        ...
        function obj = ensureIsInstance(obj)
            if ~isempty(obj)
                ...
                if ~isa(obj, 'flywheel.model.ResolverProjectNode')
                    obj = flywheel.model.ResolverProjectNode(obj);
                end
                if isKey(obj.props_, 'label')
                end
                if isKey(obj.props_, 'info')
