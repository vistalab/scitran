...
%    editions            
%
% ResolverGroupNode Methods:
%    toJson - Convert the object to a Map that can be encoded to json
%    struct - Convert the object to a struct
    classdef ResolverGroupNode < flywheel.ModelBase & flywheel.mixins.GroupMixin
    ...
    methods
        function obj = ResolverGroupNode(varargin)
            obj@flywheel.ModelBase(flywheel.model.ResolverGroupNode.propertyMap);
    ...
    methods(Static)
        function obj = fromJson(json, context)
            obj =  flywheel.model.ResolverGroupNode;
        ...
        function obj = ensureIsInstance(obj)
            if ~isempty(obj)
                ...
                if ~isa(obj, 'flywheel.model.ResolverGroupNode')
                    obj = flywheel.model.ResolverGroupNode(obj);
                end
                if isKey(obj.props_, '_id')
                end
                if isKey(obj.props_, 'label')
