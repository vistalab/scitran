...
%
% SearchParentCollection Properties:
...
%    analyses    
%
% SearchParentCollection Methods:
%    toJson - Convert the object to a Map that can be encoded to json
%    struct - Convert the object to a struct
    classdef SearchParentCollection < flywheel.ModelBase & flywheel.mixins.CollectionMixin
    ...
    methods
        function obj = SearchParentCollection(varargin)
            obj@flywheel.ModelBase(flywheel.model.SearchParentCollection.propertyMap);
    ...
    methods(Static)
        function obj = fromJson(json, context)
            obj =  flywheel.model.SearchParentCollection;
        ...
        function obj = ensureIsInstance(obj)
            if ~isempty(obj)
                ...
                if ~isa(obj, 'flywheel.model.SearchParentCollection')
                    obj = flywheel.model.SearchParentCollection(obj);
                end
                if isKey(obj.props_, 'label')
                end
                if isKey(obj.props_, 'info')
