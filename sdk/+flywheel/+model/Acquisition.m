...
%    struct - Convert the object to a struct
    classdef Acquisition < flywheel.ModelBase & flywheel.mixins.AcquisitionMixin
    ...
    methods
        function obj = Acquisition(varargin)
            obj@flywheel.ModelBase(flywheel.model.Acquisition.propertyMap);
    ...
    methods(Static)
        function obj = fromJson(json, context)
            obj =  flywheel.model.Acquisition;
        ...
        function obj = ensureIsInstance(obj)
            if ~isempty(obj)
                ...
                if ~isa(obj, 'flywheel.model.Acquisition')
                    obj = flywheel.model.Acquisition(obj);
                end
                if isKey(obj.props_, 'label')
                end
                if isKey(obj.props_, 'info')
