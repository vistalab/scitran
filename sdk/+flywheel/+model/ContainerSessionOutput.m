...
%
% ContainerSessionOutput Properties:
...
%    analyses           
%
% ContainerSessionOutput Methods:
%    toJson - Convert the object to a Map that can be encoded to json
%    struct - Convert the object to a struct
    classdef ContainerSessionOutput < flywheel.ModelBase & flywheel.mixins.SessionMixin
    ...
    methods
        function obj = ContainerSessionOutput(varargin)
            obj@flywheel.ModelBase(flywheel.model.ContainerSessionOutput.propertyMap);
    ...
    methods(Static)
        function obj = fromJson(json, context)
            obj =  flywheel.model.ContainerSessionOutput;
        ...
        function obj = ensureIsInstance(obj)
            if ~isempty(obj)
                ...
                if ~isa(obj, 'flywheel.model.ContainerSessionOutput')
                    obj = flywheel.model.ContainerSessionOutput(obj);
                end
                if isKey(obj.props_, 'operator')
                end
                if isKey(obj.props_, 'label')
