...
%
% PermissionAccessPermission Properties:
%    id      - Database ID of a user
%    access 
%
% PermissionAccessPermission Methods:
%    toJson - Convert the object to a Map that can be encoded to json
%    struct - Convert the object to a struct
    classdef PermissionAccessPermission < flywheel.ModelBase
    ...
    methods
        function obj = PermissionAccessPermission(varargin)
            obj@flywheel.ModelBase(flywheel.model.PermissionAccessPermission.propertyMap);
    ...
    methods(Static)
        function obj = fromJson(json, context)
            obj =  flywheel.model.PermissionAccessPermission;
        ...
        function obj = ensureIsInstance(obj)
            if ~isempty(obj)
                ...
                if ~isa(obj, 'flywheel.model.PermissionAccessPermission')
                    obj = flywheel.model.PermissionAccessPermission(obj);
                end
                if isKey(obj.props_, '_id')
                end
                if isKey(obj.props_, 'access')
