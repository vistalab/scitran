%% s_fwInstall
%
% To download the current CLI, go to the Flywheel site and look under your
...
%
% To make it trusted you can
%
%  https://news.trendmicro.com/2021/12/16/how-to-fix-macos-cannot-verify-that-this-app-is-free-from-malware-error/
%
